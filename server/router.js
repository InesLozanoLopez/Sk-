...
const trainingControllers = __importStar(require("./controllers/training.controllers"));
const runnerControllers = __importStar(require("./controllers/runner.controllers"));
