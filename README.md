...
<div style="display: flex; align-items: flex-start; justify-content: flex-start">
  <img src="./img/RunnerProfile.png" alt="runner profile" width="200" style="border: solid black 2px; margin: 10px;">
  <img src="./img/allTrainings.png" alt="runner profile" width="200" style="border: solid black 2px; margin: 10px;">
  <img src="./img/newRunnerForm.png" alt="runner profile" width="200" style="border: solid black 2px; margin: 10px;">
</div>
